...
const MeetingModal = ({ visible, onCancel }) => {
  const handleCancel = () => {
    onCancel();
  };
    ...
    const timePickerSuffixIcon = (
      <AiFillClockCircle className="text-blue-500" />
    );
  return (
    <Modal
    visible={visible}
  ...
  >
    ...
    <div className="note-moadal-wrap call-modal rounded-sm">
      <div className="header flex  justify-center items-center text-center bg-gray-200 rounded-sm">
        <h2 className="p-6">Schedule Meeting</h2>
      </div>
      <div className='mx-9'>


      <div className="task-name  pt-6">
        <h2 className="font-semibold  py-2">Meeting Title</h2>
        <input
          type="text"
      ...
      <div className="w-full   py-5 pb-7 rounded-lg">
        <h2 className="call-outcome font-semibold py-2">Meeting type</h2>
        ...
        <div className="outcome-option">
          ...
          >
            <Option value="positive">Audio</Option>
            <Option value="negative">Video</Option>
      ...
      <div className="notes-btn-wrap flex pr-0 pb-7 space-x-16">
      ...
      <div className="w-full   pb-7 rounded-lg">
        <h2 className="call-outcome font-semibold py-2">Duration</h2>
        ...
        <div className="outcome-option">
          <Select
            ...
            className=" rounded-md border-line  focus:outline-none w-full "
          >
            <Option value="positive">1 Hour</Option>
            <Option value="negative">2 Hour</Option>
            <Option value="disabled" disabled>
              Disabled
            </Option>
          </Select>
      ...
      <div className="w-full    pb-7 rounded-lg">
        <h2 className="call-outcome font-semibold py-2">Location</h2>
        ...
        <div className="outcome-option">
          <Select
            ...
            className=" rounded-md border-line  focus:outline-none w-full "
          >
            <Option value="positive">Zoom</Option>
            <Option value="negative">Google Meet</Option>
            <Option value="disabled" disabled>
              Disabled
            </Option>
          </Select>
      ...
      <div >
        <h2 className="py-2 font-semibold">Meeting Description</h2>
