    ...
    <>
      <div className="priority-wrap border-b-2 border-gray-300 ">
        <div className="flex lg:px-10 px-5 pt-7">
          ...
          <div className="lead-detail-wrap flex w-full mr-6 ">
            ...
            <div className="create-deal w-full flex flex-col  items-center ">

              <button onClick={showDealModal} className="mt-2 md:mx-auto text-blue-400 font-bold  text-sm lg:py-2 lg:px-4 border p-1 px-2 border-blue-700 rounded " >
        ...
        <div className="contact-btn-wrap lg:px-10 px-4 pb-10 pt-3 flex flex-wrap justify-center sm:justify-start ">
          ...
          <button onClick={showSMSModal}  className="contact-btn flex items-center bg-6192FF rounded-md px-4 py-2">
